...
async function createBookings() {
  ...
  const finalBookings = bookings.map((booking) => {
    ...
    if ((isFuture(new Date(booking.endDate)) || isToday(new Date(booking.endDate))) && isPast(new Date(booking.startDate)) &&
      !isToday(new Date(booking.startDate))) status = "checked-in";
